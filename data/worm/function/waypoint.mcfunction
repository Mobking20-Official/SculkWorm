...
data modify storage worm:macro temp set value {rotation:[0f, 0f, 0f, 1f]}
...
execute store result storage worm:macro temp.rotation[2] float 0.0174533 run scoreboard players get #angle worm
